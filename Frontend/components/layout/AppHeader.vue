...
// Props with default class names
const headerClass =
  "el-header flex justify-between items-center px-4 bg-white border-b h-16";
const leftSectionClass = "flex items-center gap-2";
const toggleButtonClass =
  "md:hidden text-gray-600 hover:text-gray-900 transition-colors";
const searchInputClass = "max-w-sm hidden sm:flex";
const rightSectionClass = "flex items-center gap-4";
const notificationBadgeClass = "cursor-pointer text-gray-600";
const darkModeButtonClass =
  "text-gray-500 hover:text-gray-800 transition-colors";
const userDropdownTriggerClass = "cursor-pointer flex items-center gap-2";
const userNameClass = "text-gray-700 text-sm";
